...
class ventana11(QMainWindow):
    def __init__(self, anterior):
        super(ventana11, self).__init__()
        ...
        self.letrero5.setText('Me gustó mucho como trabaja la madera \nes muy pulido y responsable')
        ...
        self.letrero6.setText("Me encantó su trabajo, 100% recomendado \nes muy cumplido y honesto")
        ...
        self.letrero7.setText("Usuario: Laura Tovar")
        ...
        self.letrero8.setText("Usuario: Jonathan Peña")
        ...
        self.logo = QPixmap("Logo/TRABAJO1.jpg")
        # Establecemos el modo para escalar la imagen
        ...
        self.logoFondo.move(20, 50)


        self.logoFondo1 = QLabel(self)
        self.logo = QPixmap("Logo/TRABAJO2.jpg")
        # Establecemos el modo para escalar la imagen
